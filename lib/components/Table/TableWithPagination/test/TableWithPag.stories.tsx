...
const meta: Meta<typeof TableWithPagination> = {
  title: "Design System/Entities/TableWithPagination",
  ...
  argTypes: {
    ...
    activeLng: {
      options: ["ru", "en"],
      control: { type: "radio" },
      description: "Text language in pagination component",
    },
    btnNextText: {
      description: "Text in button next",
    },
    btnPrevText: {
      description: "Text in button prev",
    },
  },
  decorators: [
    (Story) => (
